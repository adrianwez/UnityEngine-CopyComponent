...
namespace AdrianWez
{
    // Simple and powerful 'Components Cloner'
    public class CopyComponentEditor : EditorWindow
    {
        private GameObject m_Source;        // oiginal object
        private GameObject m_Destination;   // target to the components

        [UnityEditor.MenuItem("Tools/AdrianWez/Internal/Copy Components", false)]
        ...
        private Vector2 m_ScrollPosition;                       // scroll view reference
        private Dictionary<Component, bool> m_ComponentMap;     // components references
